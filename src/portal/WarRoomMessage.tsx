// src/pages/portal/WarRoomMessage.tsx
//
...
// document. Bubble style varies by sender_type.
  ...
  if (isSystem) {
    return (
      <div className="text-center">
        <div className="inline-block text-2xs uppercase tracking-widest text-ink-500 px-3 py-1 rounded-full bg-cream">
          {message.body}
        </div>
      </div>
    )
  ...
  return (
    <div className={`flex ${isClient ? 'justify-end' : 'justify-start'}`}>
      ...
      >
        <div
          className={[
            ...
            isClient
              ...
              : 'bg-cream text-[#1a1f2e] rounded-bl-md border border-[#e8e3d8]',
          ].join(' ')}
        >
          {message.body && (
              ...
              {attachments.map((att, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div
                      className={`text-[10px] ${
                        isClient ? 'text-white/70' : 'text-ink-500'
                      }`}
                    >
        ...
        <div className={`text-2xs text-ink-500 ${isClient ? 'pr-2' : 'pl-2'}`}>
